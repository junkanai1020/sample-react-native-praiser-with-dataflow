...
import { Input, SignIn, SignUp } from '../../containers';
...
function TabWithModalRoutes() {
  return (
    <ModalStack.Navigator mode="modal" headerMode="none" screenOptions={{
      cardStyle
    }}>
...
function ChooseLoginNavigator() {
  return (
    ...
    >
      ...
      <ChooseLoginStack.Screen name={SIGN_IN} component={SignIn} options={{ title: 'Sigin in' }} />
      <ChooseLoginStack.Screen name={SIGN_UP} component={SignUp} options={{ title: 'Sigin up' }} />
    </ChooseLoginStack.Navigator>
  )
}
